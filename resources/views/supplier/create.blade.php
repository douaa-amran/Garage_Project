        ...
        <div class="w-full p-7">
            <form action="{{ route('spareparts.store') }}" method="POST">
                ...
                <div class="grid grid-cols-2 gap-x-8 gap-y-4">
                    <div class="mb-5">
                        ...
                        <input type="text" id="name" name="name"
                            ...
                            placeholder="Spare part name" required />
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" id="reference" name="reference"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 "
                            placeholder="Spare part reference" required />
                    </div>
                ...
                <div class="grid mt-10 mb-4">
                    <button type="submit"
                        class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primaryBlack text-white hover:bg-black">Add
                        Spare Part</button>
                </div>
            </form>
