    ...
    <div class="w-full p-7">
        <form action="{{ route('clients.store') }}" method="POST">
            ...
            <div class="grid grid-cols-2 gap-x-8 gap-y-4">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="cin" name="cin" pattern="[A-Z][0-9]{6}"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 " placeholder="L000000"
                        required />
                </div>
                ...
                <div class="mb-5">
                    ...
                    <input type="text" id="phoneNumber" name="phoneNumber"
                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 " placeholder="123-456-7890"
                        required />
                </div>
            </div>
            ...
            <div class="grid mt-10 mb-4">
                <button type="submit"
                    class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-primaryBlack text-white hover:bg-blac">Add Client</button>
            </div>
        </form>
